...
from split.api.lineage_analysis import StatesMutationDistribution, Frequency, StatesLineageDistribution, MonthlyDistribution, StatesSequenceDistribution, StackBar, StackBar2, GenomesSeqenced, IncreaseInStrain
from split.api.filterfunction import (filter_function, LineageClassificationWeekly,
WeeklyLineageStackBar, StatesLineageClassification, LineageClassificationMonth)
from split.api.monthly_lineages import MonthlyLineageStackBar
...
urlpatterns = [
    ...
    path('monthlydistribution/', MonthlyDistribution.as_view(), name='monthlydistribution'),
    path('statesequencesdistribution/', StatesSequenceDistribution.as_view(), name='statesequencesdistribution'),
    ...
    path('monthlylineages/', MonthlyLineageStackBar.as_view(), name='monthlylineages'),


    path('genomesseqenced/', GenomesSeqenced.as_view(), name='genomesseqenced'),
    path('uniqelineagecount/', UniqeLineageCount.as_view(), name='uniqelineagecount'),
    path('uniquelineagestrain/', UniqueLineageStrain.as_view(), name='uniquelineagestrain'),
    path('increaseinstrain/', IncreaseInStrain.as_view(), name='increaseinstrain'),

    # Classification APIs
    path('linclassification/', LineageClassificationDistribution.as_view(), name='linclassification'),
    path('monthlylinclassification/', MonthlyClassificationStackBar.as_view(), name='monthlylinclassification'),
    path('weeklylinclassification/', WeeklyClassificationStackBar.as_view(), name='weeklylinclassification'),


    path('filterfunction/', filter_function.as_view(), name='filterfunction'),
    path('lineageclassificationmonth/', LineageClassificationMonth.as_view(), name='lineageclassificationmonth'),
    path('lineageclassificationweekly/', LineageClassificationWeekly.as_view(), name='lineageclassificationweekly'),
    path('stateslineageclassification/', StatesLineageClassification.as_view(), name='stateslineageclassification'),
]